...
import (
	...
	"github.com/Falokut/online_cinema_ticket_office/profiles_service/internal/interceptors"
...
func NewServer(logger logging.Logger, service *service.ProfileService) server {
