...
var (
	filter_ProfileServiceV1_GetUserProfile_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_ProfileServiceV1_GetUserProfile_0(ctx context.Context, marshaler runtime.Marshaler, client ProfileServiceV1Client, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_ProfileServiceV1_GetUserProfile_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func request_ProfileServiceV1_UpdateProfilePictureID_0(ctx context.Context, marshaler runtime.Marshaler, client ProfileServiceV1Client, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateProfilePictureIDRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.UpdateProfilePictureID(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ProfileServiceV1_UpdateProfilePictureID_0(ctx context.Context, marshaler runtime.Marshaler, server ProfileServiceV1Server, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateProfilePictureIDRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.UpdateProfilePictureID(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterProfileServiceV1HandlerServer(ctx context.Context, mux *runtime.ServeMux, server ProfileServiceV1Server) error {
	...
	mux.Handle("PATCH", pattern_ProfileServiceV1_UpdateProfilePictureID_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/profiles_service.ProfileServiceV1/UpdateProfilePictureID", runtime.WithHTTPPathPattern("/v1/profile/update-picture"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ProfileServiceV1_UpdateProfilePictureID_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_ProfileServiceV1_UpdateProfilePictureID_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterProfileServiceV1HandlerClient(ctx context.Context, mux *runtime.ServeMux, client ProfileServiceV1Client) error {
	...
	mux.Handle("PATCH", pattern_ProfileServiceV1_UpdateProfilePictureID_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/profiles_service.ProfileServiceV1/UpdateProfilePictureID", runtime.WithHTTPPathPattern("/v1/profile/update-picture"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ProfileServiceV1_UpdateProfilePictureID_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_ProfileServiceV1_UpdateProfilePictureID_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "profile", "update-picture"}, ""))
)

var (
	forward_ProfileServiceV1_GetUserProfile_0 = runtime.ForwardResponseMessage

	forward_ProfileServiceV1_UpdateProfilePictureID_0 = runtime.ForwardResponseMessage
)
